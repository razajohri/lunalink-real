          ...
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button
                ...
                className="bg-blue-500 text-white hover:bg-blue-600 transition-colors text-lg"
                size="lg"
              >
                Join the Waitlist
              </Button>
              <Button
                variant="outline"
                className="border-blue-500 text-blue-400 hover:bg-blue-900/60 transition-colors text-lg"
                size="lg"
              >
                See How It Works
              </Button>
